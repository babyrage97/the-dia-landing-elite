        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com" className="w-10 h-10 bg-muted/30 rounded-full flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-luxury group" aria-label="LinkedIn">
                <Linkedin className="h-5 w-5 group-hover:scale-110 transition-transform" />
              </a>
              <a href="https://www.twitter.com" className="w-10 h-10 bg-muted/30 rounded-full flex items-center justify-center hover:bg-secondary/20 hover:text-secondary transition-luxury group" aria-label="Twitter">
